...
const AccReportForm = ({ show, handleClose, accData, userData }) => {
  ...
  const handleAcceptSubmit = async () => {
    setLoading(true);
    try {
      await axios.put(`${dataServer.href}/api/v1/report/accept/${accData.id}`, {
        title: accData.title,
        nama: userData.nama,
