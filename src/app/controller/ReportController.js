...
exports.update = async (req, res) => {
    try {
        ...
        if (existingReport.path_report) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', 'media', 'laporan', existingReport.path_report));
        }
...
exports.delete = async (req, res) => {
    try {
        ...
        if (ReportToDelete.path_report) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', 'media', 'laporan', ReportToDelete.path_report));
        }
