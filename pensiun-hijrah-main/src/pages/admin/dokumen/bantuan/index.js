...
import { BantuanHeader } from '../../../../components/Admin/HeaderSection/Data';
import Bantuan from '../../../../components/Admin/Dokumen/Bantuan';
...
const BantuanAdmin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Bantuan | DPLK Syariah Muamalat</title>
      </Helmet>
      <Sidebar isOpen={isOpen} toggle={toggle} userData={userData} />
      <Navbar toggle={toggle} userData={userData} />
      <HeaderSection {...BantuanHeader} />
      <Bantuan userData={userData} />
