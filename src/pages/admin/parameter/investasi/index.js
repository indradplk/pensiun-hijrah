...
import { ParameterPaketHeader } from '../../../../components/Admin/HeaderSection/Data';
import Investasi from '../../../../components/Admin/Parameter/Investasi';
import Footer from '../../../../components/Admin/Footer';
import SessionModal from '../../../../components/Admin/Modal/Session';
import { dataServer } from '../../../../components/DataServer';

const ParameterPaketAdmin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Parameter Paket Investasi | DPLK Syariah Muamalat</title>
      </Helmet>
      <Sidebar isOpen={isOpen} toggle={toggle} userData={userData} />
      <Navbar toggle={toggle} userData={userData} />
      <HeaderSection {...ParameterPaketHeader} />
      <Investasi userData={userData} />
...
export default ParameterPaketAdmin;