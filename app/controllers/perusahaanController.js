...
exports.editPeserta = async (req, res) => {
  try {
    ...
    let updateUser = await User.update(
      { password: hashedPassword, perusahaanEmail: email, userUpdate },
      { where: { username } }
    );
...
exports.registrasiPerusahaan = async (req, res) => {
  try {
...
exports.unblockAccount = async (req, res) => {
  try {
    ...
    await ActivityAdmin.create({
      nik: userUpdate,
      log: `${userUpdate} mereset ulang akun perusahaan ${no_peserta}`
    });
