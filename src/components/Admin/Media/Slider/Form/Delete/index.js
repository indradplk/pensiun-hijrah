...
const DeleteSliderForm = ({ show, handleClose, deleteData, userData }) => {
  ...
  const handleDeleteSubmit = async () => {
    ...
    try {
      await axios.delete(`${dataServer.href}/api/v1/slider/${deleteData.id}`, {
        data: {
          judul: deleteData.judul,
          nama: userData.nama,
...
export default DeleteSliderForm;
