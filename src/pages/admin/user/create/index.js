...
import { RegisterAdminHeader } from '../../../../components/Admin/HeaderSection/Data';
import CreateAdminPage from '../../../../components/Admin/User/Create';
...
const CreateAdmin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Buat Admin Baru | DPLK Syariah Muamalat</title>
      </Helmet>
      <Sidebar isOpen={isOpen} toggle={toggle} userData={userData} />
      <Navbar toggle={toggle} userData={userData} />
      <HeaderSection {...RegisterAdminHeader} />
      <CreateAdminPage userData={userData} />
