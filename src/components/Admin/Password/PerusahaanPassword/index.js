...
import PasswordPerusahaanModal from '../../Modal/PasswordPerusahaan';
...
const ResetPasswordPerusahaan = ({userData}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response1 = await axios.get(`${dataServer.href}:4000/api/v1/perusahaan/${no_peserta}`);
      const response2 = await axios.get(`${dataServer.href}:4000/api/v1/ppukp/peserta/${no_peserta}`);
