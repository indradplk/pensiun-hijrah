...
import { BlockHeader } from '../../../../components/Admin/HeaderSection/Data';
import UnblockPerusahaan from '../../../../components/Admin/Block/PerusahaanBlock';
import Footer from '../../../../components/Admin/Footer';
import SessionModal from '../../../../components/Admin/Modal/Session';
import { dataServer } from '../../../../components/DataServer';

const BlockPerusahaan = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Reset Password Perusahaan | DPLK Syariah Muamalat</title>
      </Helmet>
      <Sidebar isOpen={isOpen} toggle={toggle} userData={userData} />
      <Navbar toggle={toggle} userData={userData} />
      <HeaderSection {...BlockHeader} />
      <UnblockPerusahaan userData={userData} />
...
export default BlockPerusahaan;