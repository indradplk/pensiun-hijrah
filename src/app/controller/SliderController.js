...
exports.update = async (req, res) => {
    try {
        ...
        if (existingSlider.path_web) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', existingSlider.path_web));
        }
        if (existingSlider.path_mobile) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', existingSlider.path_mobile));
        }
...
exports.delete = async (req, res) => {
    try {
        ...
        if (sliderToDelete.path_web) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', sliderToDelete.path_web));
        }
        if (sliderToDelete.path_mobile) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', sliderToDelete.path_mobile));
        }
