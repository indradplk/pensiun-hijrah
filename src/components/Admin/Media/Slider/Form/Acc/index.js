...
const AccSliderForm = ({ show, handleClose, accData, userData }) => {
  ...
  const handleAcceptSubmit = async () => {
    setLoading(true);
    try {
      await axios.put(`${dataServer.href}/api/v1/slider/accept/${accData.id}`, {
        judul: accData.judul,
        nama: userData.nama,
