...
const DeleteBantuanForm = ({ show, handleClose, deleteData, userData }) => {
  ...
  const handleDeleteSubmit = async () => {
    ...
    try {
      await axios.delete(`${dataServer.href}/api/v1/bantuan/${deleteData.id}`, {
        data: {
  ...
  return (
    <Modal show={show} onHide={handleClose} centered>
      <Modal.Header closeButton>
        <FormH1>Hapus Dokumen Bantuan</FormH1>
      </Modal.Header>
      <Modal.Body>
        <Form>
...
export default DeleteBantuanForm;
