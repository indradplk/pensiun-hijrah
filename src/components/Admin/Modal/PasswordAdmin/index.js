...
const PasswordAdminModal = ({ show, handleClose, pesertaData, userData }) => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await axios.post(`${dataServer.href}/api/v1/admin/reset-password/${pesertaData.nik}`, {
        nama: userData.nama,
    ...
    <Modal show={show} onHide={handleClose} centered>
      ...
      <Modal.Body>
        <Form>
          ...
          <ModalInput id="nik" type="text" name="nik" value={pesertaData.nik} disabled />
          <ModalLabel htmlFor="nama">Nama</ModalLabel>
          <ModalInput id="nama" type="text" name="nama" value={pesertaData.nama} disabled />
