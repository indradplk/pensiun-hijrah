...
const EditBantuanForm = ({ show, handleClose, editData, handleEditInputChange }) => {
  ...
  useEffect(() => {
    setFormData({
      ...
      path_panduan: editData.path_panduan,
    ...
    <Modal show={show} onHide={handleClose} centered>
      ...
      <Modal.Body>
        <Form>
          ...
          <FormInput id="path_panduan" type="file" name="path_panduan" onChange={handleEditInputChange} />
