...
const EditReportForm = ({ show, handleClose, editData, handleEditInputChange, userData }) => {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${dataServer.href}/api/v1/report/${editData.id}`, formData, {
        headers: {
