...
const DeleteManagementForm = ({ show, handleClose, deleteData, userData }) => {
  ...
  const handleDeleteSubmit = async () => {
    ...
    try {
      await axios.delete(`${dataServer.href}/api/v1/management/${deleteData.id}`, {
        data: {
...
export default DeleteManagementForm;
