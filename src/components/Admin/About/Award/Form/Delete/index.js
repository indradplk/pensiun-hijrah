...
const DeleteAwardForm = ({ show, handleClose, deleteData, userData }) => {
  ...
  const handleDeleteSubmit = async () => {
    ...
    try {
      await axios.delete(`${dataServer.href}/api/v1/award/${deleteData.id}`, {
        data: {
  ...
  return (
    <Modal show={show} onHide={handleClose} centered>
      <Modal.Header closeButton>
        <FormH1>Hapus Penghargaan</FormH1>
      </Modal.Header>
      <Modal.Body>
        <Form>
