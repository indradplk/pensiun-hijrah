...
exports.create = async (req, res) => {
    try {
        ...
        const foto_ktp = path.basename(req.files.foto_ktp[0].path);
        const foto_npwp = path.basename(req.files.foto_npwp[0].path);
        const foto_kk = path.basename(req.files.foto_kk[0].path);
