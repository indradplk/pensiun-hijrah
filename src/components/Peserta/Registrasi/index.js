...
const Registrasi = () => {
  ...
  useEffect(() => {
    axios.get(`${dataServer.href}/api/v1/master/sampingan`)
      .then(response => {
        setPenghasilanTambahan(response.data);
      })
      .catch(error => console.error('Error fetching penghasilan:', error));
  }, []);
  ...
  useEffect(() => {
    axios.get(`${dataServer.href}/api/v1/master/dana`)
      .then(response => {
        setDanaIuran(response.data);
      })
      .catch(error => console.error('Error fetching sumber dana:', error));
  }, []);

  useEffect(() => {
    axios.get(`${dataServer.href}/api/v1/office`)
      .then(response => {
        setCabangDaftar(response.data);
      })
  ...
  const handleProvinsiRumahChange = (event) => {
    ...
    axios.get(`${dataServer.href}/api/v1/wilayah/district?provinsi_id=${selectedProvinsiRumah.id}`)
      .then(response => {
        setKotaRumah(response.data);
      })
      .catch(error => console.error('Error fetching cities:', error));
  };
  ...
  const handleKotaRumahChange = (event) => {
    ...
    axios.get(`${dataServer.href}/api/v1/wilayah/subdistrict?kabupaten_id=${selectedKotaRumah.id}`)
      .then(response => {
        setKecamatanRumah(response.data);
      })
      .catch(error => console.error('Error fetching sub-cities:', error));
  };
  ...
  const handleKecamatanRumahChange = (event) => {
    ...
    axios.get(`${dataServer.href}/api/v1/wilayah/village?kecamatan_id=${selectedKecamatanRumah.id}`)
      .then(response => {
        setKelurahanRumah(response.data);
      })
      .catch(error => console.error('Error fetching villages:', error));
  };
  ...
  const handleProvinsiKantorChange = (event) => {
    ...
    axios.get(`${dataServer.href}/api/v1/wilayah/district?provinsi_id=${selectedProvinsiKantor.id}`)
      .then(response => {
        setKotaKantor(response.data);
      })
      .catch(error => console.error('Error fetching cities:', error));
  };
  ...
  const handleKotaKantorChange = (event) => {
    ...
    axios.get(`${dataServer.href}/api/v1/wilayah/subdistrict?kabupaten_id=${selectedKotaKantor.id}`)
      .then(response => {
        setKecamatanKantor(response.data);
      })
      .catch(error => console.error('Error fetching sub-cities:', error));
  };
  ...
  const handleKecamatanKantorChange = (event) => {
    ...
    axios.get(`${dataServer.href}/api/v1/wilayah/village?kecamatan_id=${selectedKecamatanKantor.id}`)
      .then(response => {
        setKelurahanKantor(response.data);
      })
      .catch(error => console.error('Error fetching villages:', error));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        // First POST request
        const registrasiResponse = await axios.post(`${dataServer.href}/api/v1/registrasi`, data, {
            headers: {
                'Content-Type': 'multipart/form-data',
            },
        });

        console.log(registrasiResponse.data);
        ...
        // Second POST request
        const ppipResponse = await axios.post(`${dataServer.href}/api/v1/ppip/registrasi`, ppipData, {
            headers: {
                'Content-Type': 'application/json',
            },
        });

        console.log(ppipResponse.data);
