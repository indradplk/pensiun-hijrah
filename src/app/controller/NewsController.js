...
exports.update = async (req, res) => {
    try {
        ...
        if (existingNews.path_news) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', 'media', 'berita', existingNews.path_news));
        }
...
exports.delete = async (req, res) => {
    try {
        ...
        if (NewsToDelete.path_news) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', 'media', 'berita', NewsToDelete.path_news));
        }
