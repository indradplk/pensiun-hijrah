...
exports.update = async (req, res) => {
    try {
        ...
        if (existingAward.path_award) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', 'about', 'penghargaan', existingAward.path_award));
        }
...
exports.delete = async (req, res) => {
    try {
        ...
        if (awardToDelete.path_award) {
            fs.unlinkSync(path.join(__dirname, '..', '..', '..', 'public', 'about', 'penghargaan', awardToDelete.path_award));
        }
